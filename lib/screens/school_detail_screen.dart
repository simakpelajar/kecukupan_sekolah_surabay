            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      LevelBadge(level: school.level, fontSize: 13),
                      SizedBox(width: 8),
                      InfoBadge(text: "NPSN: ${school.npsn}", fontSize: 13),
                    ],
                  ),
                ],
              ),
                    ...
                    builder:
                        (context) => MapScreen(
                          ...
                          userLocation: {
                            ...
                            'isSchool':
                                true, // Flag untuk membedakan lokasi sekolah dan lokasi pengguna
                          },
                        ),
                  ),
                );
